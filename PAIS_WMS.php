...
$request->setParameter('LAYERS','rasterLayer');
...
$pa = cleanParamValue($_REQUEST,'pa');
// Mandatory parameter - TODO handle absence by generating a useful error
$year = cleanParamValue($_REQUEST,'year');
// Mandatory parameter - TODO handle absence by generating a useful error
$datafile = $pa . "_" . $year . ".tif";
...
$epsg = "+init=epsg:4326";
//$srs = "EPSG:" . cleanParamValue($_REQUEST,'epsg');
...
$oMap->setMetadata("ows_onlineresource","http://h03-dev-vm3.jrc.it/mapserver_utils/PAIS_WMS.php");
$oMap->setMetadata("ows_srs","EPSG:" . $_REQUEST["epsg"]);
      ...
      $Layer=array(
        "set"=>array(
          ...
          "metadata"=>array("ows_srs"=>"EPSG:4326",
